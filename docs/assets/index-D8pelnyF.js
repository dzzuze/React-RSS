...
var l = o((e) => {
  ...
  h = o((e) => {
    ...
    function O(e) {
      0 > fe || ((e.current = D[fe]), (D[fe] = null), fe--);
    }
    function k(e, t) {
      (fe++, (D[fe] = e.current), (e.current = t));
    }
    var me = pe(null),
      he = pe(null),
      ge = pe(null),
        ...
        case 6:
          if (e && t.stateNode != null) e.memoizedProps !== r && Fc(t);
            ...
            if (((e = ge.current), qi(t))) {
              ...
              ((e = Bd(e).createTextNode(r)), (e[A] = t), (t.stateNode = e));
          }
          return (H(t), null);
        case 31:
...
`
  ...
  _ = c(u(), 1),
  v = g();
function y({ storageKey: e, initialValue: t }) {
  let [n, r] = (0, _.useState)(i);
  function i() {
    let n = localStorage.getItem(e);
    return n === null ? t : n;
  }
  function a(t) {
    (localStorage.setItem(e, t), r(t));
  }
  return [n, a];
}
var b = o((e) => {
...
function ee({ onSearch: e }) {
  let [t, n] = y({ storageKey: `searchTermTemp`, initialValue: `` }),
    [r, i] = (0, _.useState)(t),
    [a, o] = (0, _.useState)(t);
  return (0, x.jsxs)(`div`, {
    className: `p-4 bg-gray-100 rounded-lg shadow-sm mb-4 flex gap-5`,
    children: [
      (0, x.jsx)(`input`, {
        onChange: (e) => {
          i(e.target.value);
...
var re = (e) => {
  ...
  w = ((e) => (e ? re(e) : re))((e) => ({
    ...
    toggle: (t) =>
      e((e) => {
        let n = new Set(e.selectedIds);
        return (n.has(t) ? n.delete(t) : n.add(t), { selectedIds: n });
      }),
    clear: () => e({ selectedIds: new Set() }),
  }));
function ie({ name: e, description: t, image: n, id: r }) {
  let i = w((e) => e.toggle);
  return (0, x.jsxs)(`div`, {
    className: `relative border rounded-lg p-4 shadow-sm flex flex-col items-center`,
    children: [
      (0, x.jsx)(`input`, {
        type: `checkbox`,
        checked: w((e) => e.selectedIds.has(r)),
        onChange: (e) => {
      ...
      ` `,
      (0, x.jsx)(`h3`, { className: `text-lg font-bold`, children: e }),
      (0, x.jsx)(`p`, { className: `text-sm text-gray-600`, children: t }),
    ],
  });
}
function ae({ items: e }) {
  return (0, x.jsx)(`div`, {
    ...
    children: e.map((e, t) =>
      (0, x.jsx)(
        ie,
        { name: e.name, description: e.description, image: e.image, id: e.id },
        t
      )
    ),
  });
}
var oe = class extends _.Component {
    constructor(e) {
...
function me({ pathname: e = `/`, search: t = ``, hash: n = `` }) {
  return (
...
function ye(e, t, n, r, i) {
  let a = Re((typeof t == `string` ? he(t) : t).pathname || `/`, n);
  if (a == null) return null;
  let o = i ?? xe(e),
    s = null,
    c = Le(a);
  for (let e = 0; s == null && e < o.length; ++e) s = Pe(o[e], c, r);
  return s;
}
function be(e, t) {
...
function Me(e, t) {
  ...
  return (
    ...
    n
      .filter((e) => !je(e))
      .reduce((e, t) => e + (Te.test(t) ? Ee : t === `` ? Oe : ke), r)
  );
}
function Ne(e, t) {
...
function Pe(e, t, n = !1) {
  ...
  for (let e = 0; e < r.length; ++e) {
    ...
    (Object.assign(i, u.params),
      o.push({
        params: i,
        pathname: qe([a, u.pathname]),
        pathnameBase: Ye(qe([a, u.pathnameBase])),
        route: d,
      }),
      u.pathnameBase !== `/` && (a = qe([a, u.pathnameBase])));
  }
  return o;
}
function Fe(e, t) {
...
function Be(e, t = `/`) {
  ...
  return (
    n
      ? ((n = Ke(n)),
        (a = n.startsWith(`/`) ? Ve(n.substring(1), `/`) : Ve(n, t)))
      : (a = t),
    { pathname: a, search: Xe(r), hash: Ze(i) }
  );
}
function Ve(e, t) {
  let n = Je(t).split(`/`);
  ...
  typeof e == `string`
    ...
    : ((i = { ...e }),
      D(
        ...
        He(`?`, `pathname`, `search`, i)
      ),
      D(
        !i.pathname || !i.pathname.includes(`#`),
        He(`#`, `pathname`, `hash`, i)
      ),
      D(!i.search || !i.search.includes(`#`), He(`#`, `search`, `hash`, i)));
  let a = e === `` || i.pathname === ``,
    o = a ? `/` : i.pathname,
    s;
  if (o == null) s = n;
...
function et(e) {
  return qe(e.map((e) => e.route.path).filter(Boolean)) || `/`;
}
var tt =
  typeof window < `u` &&
  window.document !== void 0 &&
...
at.displayName = `DataRouter`;
var ot = _.createContext(null);
ot.displayName = `DataRouterState`;
var st = _.createContext(!1);
function ct() {
  return _.useContext(st);
}
var lt = _.createContext({ isTransitioning: !1 });
lt.displayName = `ViewTransition`;
var ut = _.createContext(new Map());
...
var pt = _.createContext(null);
pt.displayName = `Location`;
var mt = _.createContext({ outlet: null, matches: [], isDataRoute: !1 });
mt.displayName = `Route`;
var A = _.createContext(null);
A.displayName = `RouteError`;
var ht = `REACT_ROUTER_ERROR`,
  gt = `REDIRECT`,
  _t = `ROUTE_ERROR_RESPONSE`;
function vt(e) {
  if (e.startsWith(`${ht}:${gt}:{`))
    try {
...
function bt(e, { relative: t } = {}) {
  D(xt(), `useHref() may be used only in the context of a <Router> component.`);
  let { basename: n, navigator: r } = _.useContext(ft),
...
function St() {
  return (
    ...
    _.useContext(pt).location
  );
}
var Ct = `You should call navigate() in a React.useEffect(), not when your component is first rendered.`;
function wt(e) {
  _.useContext(ft).static || _.useLayoutEffect(e);
}
function Tt() {
  let { isDataRoute: e } = _.useContext(mt);
  return e ? Gt() : Et();
}
function Et() {
  D(
  ...
  let e = _.useContext(at),
    { basename: t, navigator: n } = _.useContext(ft),
    { matches: r } = _.useContext(mt),
    { pathname: i } = St(),
    a = JSON.stringify(We(r)),
    o = _.useRef(!1);
  return (
    wt(() => {
      o.current = !0;
    ...
    _.useCallback(
      (r, s = {}) => {
        if ((fe(o.current, Ct), !o.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
        let c = Ge(r, JSON.parse(a), i, s.relative === `path`);
        (e == null &&
          t !== `/` &&
          (c.pathname = c.pathname === `/` ? t : qe([t, c.pathname])),
...
function j(e, { relative: t } = {}) {
  let { matches: n } = _.useContext(mt),
    { pathname: r } = St(),
    i = JSON.stringify(We(n));
  return _.useMemo(() => Ge(e, JSON.parse(i), r, t === `path`), [e, i, r, t]);
}
function Dt(e, t) {
  return Ot(e, t);
}
function Ot(e, t, n) {
  ...
  let { navigator: r } = _.useContext(ft),
    { matches: i } = _.useContext(mt),
    a = i[i.length - 1],
    o = a ? a.params : {},
    s = a ? a.pathname : `/`,
    c = a ? a.pathnameBase : `/`,
...
var At = _.createElement(kt, null),
  jt = class extends _.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
      ...
      let t =
        e === void 0
          ...
          : _.createElement(
              ...
              _.createElement(A.Provider, {
                value: e,
                children: this.props.component,
              })
            );
      return this.context ? _.createElement(Nt, { error: e }, t) : t;
    }
  };
jt.contextType = st;
var Mt = new WeakMap();
function Nt({ children: e, error: t }) {
  let { basename: n } = _.useContext(ft);
  if (
    typeof t == `object` &&
    t &&
    `digest` in t &&
...
function Pt({ routeContext: e, match: t, children: n }) {
  ...
  return (
    ...
    _.createElement(mt.Provider, { value: e }, n)
  );
}
function Ft(e, t = [], n) {
  let r = n?.state;
...
function Vt() {
  return Bt(`useRouteId`);
}
function Ht() {
  let e = Rt(`useNavigation`);
  return _.useMemo(() => {
...
function Ut() {
  let { matches: e, loaderData: t } = Rt(`useMatches`);
  return _.useMemo(() => e.map((e) => be(e, t)), [e, t]);
}
function Wt() {
  let e = _.useContext(A),
    t = Rt(`useRouteError`),
    n = Bt(`useRouteError`);
  ...
  return (
    ...
    h == null
      ...
      : _.createElement(
          ft.Provider,
          { value: c },
          _.createElement(pt.Provider, { children: t, value: h })
        )
  );
}
...
function sn(e, t) {
  return e.button === 0 && (!t || t === `_self`) && !on(e);
}
function cn(e = ``) {
...
function dn() {
  if (un === null)
    try {
      (new FormData(document.createElement(`form`), 0), (un = !1));
    } catch {
      un = !0;
    }
  return un;
...
function mn(e, t) {
  ...
  if (rn(e)) {
    ...
    ((r = o ? Re(o, t) : null),
      (n = e.getAttribute(`method`) || $t),
      (i = pn(e.getAttribute(`enctype`)) || en),
      (a = new FormData(e)));
  } else if (nn(e) || (an(e) && (e.type === `submit` || e.type === `image`))) {
    let o = e.form;
    if (o == null)
      throw Error(
    ...
    if (
      ((r = s ? Re(s, t) : null),
      (n = e.getAttribute(`formmethod`) || o.getAttribute(`method`) || $t),
      (i =
        pn(e.getAttribute(`formenctype`)) ||
        pn(o.getAttribute(`enctype`)) ||
        en),
      (a = new FormData(o, e)),
      !dn())
    ) {
...
async function bn(e, t) {
  ...
  try {
    let n = await ue(() => import(e.module), []);
    return ((t[e.id] = n), n);
  } catch (t) {
    return (
      console.error(
...
function Tn(e, t, { includeHydrateFallback: n } = {}) {
  return En(
    e
      .map((e) => {
        let r = t.routes[e.route.id];
...
function On(e, t) {
  let n = new Set(),
    r = new Set(t);
  return e.reduce((e, i) => {
    if (t && !xn(i) && i.as === `script` && i.href && r.has(i.href)) return e;
    let a = JSON.stringify(Dn(i));
...
var jn = _.createContext(void 0);
jn.displayName = `FrameworkContext`;
function Mn() {
  let e = _.useContext(jn);
  return (
    vn(e, `You must render this element inside a <HydratedRouter> element`),
    e
  );
}
function Nn(e, t) {
  let n = _.useContext(jn),
    [r, i] = _.useState(!1),
    [a, o] = _.useState(!1),
    {
      onFocus: s,
...
function Fn({ page: e, ...t }) {
  let n = ct(),
    { router: r } = kn(),
    i = _.useMemo(() => ve(r.routes, e, r.basename), [r.routes, e, r.basename]);
  return i
    ? n
      ? _.createElement(Ln, { page: e, matches: i, ...t })
      : _.createElement(Rn, { page: e, matches: i, ...t })
    : null;
}
function In(e) {
...
function Ln({ page: e, matches: t, ...n }) {
  let r = St(),
    ...
    o = _.useMemo(() => {
      ...
      let n = yn(e, a, i.unstable_trailingSlashAwareDataRequests, `rsc`),
        o = !1,
        s = [];
      for (let e of t)
...
function Rn({ page: e, matches: t, ...n }) {
  let r = St(),
    { future: i, manifest: a, routeModules: o } = Mn(),
    { basename: s } = kn(),
    { loaderData: c, matches: l } = An(),
    u = _.useMemo(() => wn(e, t, l, a, r, `data`), [e, t, l, a, r]),
    d = _.useMemo(() => wn(e, t, l, a, r, `assets`), [e, t, l, a, r]),
    f = _.useMemo(() => {
      if (e === r.pathname + r.search + r.hash) return [];
      let n = new Set(),
        l = !1;
      if (
        ...
        return [];
      let d = yn(e, s, i.unstable_trailingSlashAwareDataRequests, `data`);
      return (
        l &&
          n.size > 0 &&
          d.searchParams.set(
...
var Bn =
  ...
  window.document.createElement !== void 0;
try {
  Bn && (window.__reactRouterVersion = `7.15.1`);
} catch {}
function Vn({ basename: e, children: t, useTransitions: n, window: r }) {
  let i = _.useRef();
  i.current ??= de({ window: r, v5Compat: !0 });
  let a = i.current,
...
function Hn({ basename: e, children: t, history: n, useTransitions: r }) {
...
Hn.displayName = `unstable_HistoryRouter`;
var Un = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Wn = _.forwardRef(function (
    {
      onClick: e,
      discover: t = `render`,
      prefetch: n = `none`,
    ...
    let { basename: h, navigator: g, useTransitions: v } = _.useContext(ft),
      y = typeof l == `string` && Un.test(l),
      b = nt(l, h);
    l = b.to;
    let x = bt(l, { relative: r }),
      ee = St(),
      S = null;
    if (o) {
      let e = Ge(o, [], ee.mask ? ee.mask.pathname : `/`, !0);
      (h !== `/` && (e.pathname = e.pathname === `/` ? h : qe([h, e.pathname])),
        (S = g.createHref(e)));
    }
    let [C, te, ne] = Nn(n, p),
      re = Zn(l, {
    ...
    return C && !y
      ? _.createElement(_.Fragment, null, ae, _.createElement(Fn, { page: x }))
      : ae;
  });
Wn.displayName = `Link`;
var Gn = _.forwardRef(function (
  {
    'aria-current': e = `page`,
    caseSensitive: t = !1,
    className: n = ``,
  ...
  let u = j(a, { relative: c.relative }),
    d = St(),
    f = _.useContext(ot),
    { navigator: p, basename: m } = _.useContext(ft),
    h = f != null && cr(u) && o === !0,
...
var Kn = _.forwardRef(
  (
    ...
    let { useTransitions: h } = _.useContext(ft),
      g = tr(),
      v = nr(s, { relative: l }),
...
Kn.displayName = `Form`;
function qn({ getKey: e, storageKey: t, ...n }) {
  let r = _.useContext(jn),
    { basename: i } = _.useContext(ft),
    a = St(),
    o = Ut();
  or({ getKey: e, storageKey: t });
  let s = _.useMemo(() => {
    if (!r || !e) return null;
    let t = ar(a, o, i, e);
  ...
  return _.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${c})(${_n(JSON.stringify(t || rr))}, ${_n(JSON.stringify(s))})`,
    },
  });
}
...
function Qn(e) {
  ...
  let t = _.useRef(cn(e)),
    n = _.useRef(!1),
    r = St(),
    i = _.useMemo(() => ln(r.search, n.current ? null : t.current), [r.search]),
    a = Tt();
  return [
    i,
    _.useCallback(
      (e, t) => {
        let r = cn(typeof e == `function` ? e(new URLSearchParams(i)) : e);
        ((n.current = !0), a(`?` + r, t));
      },
      [a, i]
    ),
...
function tr() {
  let { router: e } = Yn(`useSubmit`),
    { basename: t } = _.useContext(ft),
    n = Vt(),
    r = e.fetch,
    i = e.navigate;
  return _.useCallback(
    async (e, a = {}) => {
      let { action: o, method: s, encType: c, formData: l, body: u } = mn(e, t);
      a.navigate === !1
        ? await r(a.fetcherKey || er(), n, a.action || o, {
...
var rr = `react-router-scroll-positions`,
  ir = {};
function ar(e, t, n, r) {
  let i = null;
  return (
    r &&
      (i = r(
        n === `/` ? e : { ...e, pathname: Re(e.pathname, n) || e.pathname },
        t
      )),
    (i ??= e.key),
    i
...
function or({ getKey: e, storageKey: t } = {}) {
  let { router: n } = Yn(`useScrollRestoration`),
    { restoreScrollPosition: r, preventScrollReset: i } =
      Xn(`useScrollRestoration`),
    { basename: a } = _.useContext(ft),
    o = St(),
    s = Ut(),
    c = Ht();
  (_.useEffect(
    ...
    sr(
      _.useCallback(() => {
        ...
        try {
          sessionStorage.setItem(t || rr, JSON.stringify(ir));
        } catch (e) {
          fe(
            !1,
    ...
    typeof document < `u` &&
      (_.useLayoutEffect(() => {
        try {
          let e = sessionStorage.getItem(t || rr);
          e && (ir = JSON.parse(e));
        } catch {}
      }, [t]),
      _.useLayoutEffect(() => {
...
function cr(e, { relative: t } = {}) {
  ...
  let a = Re(n.currentLocation.pathname, r) || n.currentLocation.pathname,
    o = Re(n.nextLocation.pathname, r) || n.nextLocation.pathname;
  return Fe(i.pathname, o) != null || Fe(i.pathname, a) != null;
}
function lr() {
  let e = Tt();
  return (0, x.jsxs)(`div`, {
    className: `max-w-4xl mx-auto p-4 min-h-screen flex flex-col gap-4 items-center`,
    children: [
      (0, x.jsx)(`div`, { className: `flex-1` }),
      (0, x.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, x.jsx)(`h2`, {
            ...
            children: `Rick and Morty API`,
          }),
          (0, x.jsx)(`p`, {
            className: `text-gray-600`,
            children: `Hi, im dzzuze! This is my web-site🪐`,
          }),
          (0, x.jsx)(`div`, {
...
function ur() {
  let e = Tt();
  return (0, x.jsxs)(`div`, {
    className: `max-w-4xl mx-auto p-4 min-h-screen flex flex-col gap-4 justify-center items-center`,
    children: [
      (0, x.jsx)(`h1`, {
        className: `text-3xl font-bold`,
...
var dr = (0, _.createContext)({ theme: `light`, toggleTheme: () => {} }),
  fr = () => (0, _.useContext)(dr),
  pr = class {
    constructor() {
...
var vr = typeof window > `u` || `Deno` in globalThis;
function yr() {}
function br(e, t) {
...
function Tr(e, t) {
  ...
  if (o) {
    if (r) {
      if (t.queryHash !== Dr(o, t.options)) return !1;
    } else if (!kr(t.queryKey, o)) return !1;
  }
  if (n !== `all`) {
    let e = t.isActive();
...
function Er(e, t) {
  ...
  if (a) {
    ...
    } else if (!kr(t.options.mutationKey, a)) return !1;
  }
  return !((r && t.state.status !== r) || (i && !i(t)));
}
function Dr(e, t) {
  return (t?.queryKeyHashFn || Or)(e);
}
function Or(e) {
...
function kr(e, t) {
  return e === t
    ...
    : typeof e == typeof t &&
        ...
        typeof e == `object` &&
        typeof t == `object`
      ? Object.keys(t).every((n) => kr(e[n], t[n]))
      : !1;
}
...
function $r(e) {
  let t = !1,
    ...
    l = () =>
      mr.isFocused() &&
      (e.networkMode === `always` || Yr.isOnline()) &&
      e.canRun(),
    u = () => Zr(e.networkMode) && e.canRun(),
    d = (e) => {
      a() || (r?.(), i.resolve(e));
    },
    f = (e) => {
      ...
      let r = t.options,
        ...
        l = async () => {
          ...
          if (i && a.length) {
            ...
            let t = e ?? a.length;
            do {
              let e = c === 0 ? (o[0] ?? r.initialPageParam) : ni(r, s);
              if (c > 0 && e == null) break;
              ((s = await d(s, e)), c++);
            } while (c < t);
          }
...
var ii = class extends ei {
  ...
  setOptions(e) {
    if (
      ...
      let e = si(this.options);
      e.data !== void 0 &&
        (this.setState(oi(e.data, e.dataUpdatedAt)), (this.#t = e));
    }
  }
  optionalRemove() {
  ...
  setData(e, t) {
    let n = Lr(this.state.data, e, this.options);
    return (
      this.#l({
        data: n,
        type: `success`,
  ...
  cancel(e) {
    ...
    return (this.#a?.cancel(e), t ? t.then(yr).catch(yr) : Promise.resolve());
  }
  destroy() {
  ...
  isActive() {
    return this.observers.some((e) => wr(e.options.enabled, this) !== !1);
  }
  isDisabled() {
    return this.getObserversCount() > 0
      ? !this.isActive()
      : this.options.queryFn === Br || !this.isFetched();
  }
  isFetched() {
    ...
    let t = (t) => {
      switch (e.type) {
        ...
        case `fetch`:
          return {
            ...t,
            ...ai(t.data, this.options),
            fetchMeta: e.meta ?? null,
          };
        case `success`:
          let n = {
            ...t,
            ...oi(e.data, e.dataUpdatedAt),
...
var ci = class extends pr {
  ...
  onSubscribe() {
    this.listeners.size === 1 &&
      ...
      ui(this.#t, this.options) ? this.#h() : this.updateResult(),
      this.#y());
  }
  onUnsubscribe() {
  ...
  setOptions(e) {
    ...
    if (
      ...
      this.options.enabled !== void 0 &&
        ...
        typeof wr(this.options.enabled, this.#t) != `boolean`)
    )
      throw Error(
    ...
    (r && fi(this.#t, n, this.options, t) && this.#h(),
      this.updateResult(),
      r &&
        (this.#t !== n ||
          wr(this.options.enabled, this.#t) !== wr(t.enabled, this.#t) ||
          Cr(this.options.staleTime, this.#t) !== Cr(t.staleTime, this.#t)) &&
        this.#g());
    let i = this.#_();
    r &&
      (this.#t !== n ||
  ...
  #h(e) {
    ...
    return (e?.throwOnError || (t = t.catch(yr)), t);
  }
  #g() {
    this.#b();
    let e = Cr(this.options.staleTime, this.#t);
    if (Wr.isServer() || this.#r.isStale || !xr(e)) return;
    let t = Sr(this.#r.dataUpdatedAt, e) + 1;
    this.#d = gr.setTimeout(() => {
  ...
  #v(e) {
    (this.#x(),
      ...
      !(
        Wr.isServer() ||
        wr(this.options.enabled, this.#t) === !1 ||
        !xr(this.#p) ||
        this.#p === 0
      ) &&
        (this.#f = gr.setInterval(() => {
          (this.options.refetchIntervalInBackground || mr.isFocused()) &&
            this.#h();
        }, this.#p)));
  }
  #y() {
  ...
  #b() {
    this.#d !== void 0 && (gr.clearTimeout(this.#d), (this.#d = void 0));
  }
  #x() {
    this.#f !== void 0 && (gr.clearInterval(this.#f), (this.#f = void 0));
  }
  createResult(e, t) {
    let n = this.#t,
      r = this.options,
      ...
      (i?.isPlaceholderData && t.placeholderData === o?.placeholderData
        ...
        : (e =
            typeof t.placeholderData == `function`
              ...
              : t.placeholderData),
        e !== void 0 && ((m = `success`), (d = Lr(i?.data, e, t)), (u = !0)));
    }
...
function li(e, t) {
  return (
    wr(t.enabled, e) !== !1 &&
    e.state.data === void 0 &&
    !(e.state.status === `error` && wr(t.retryOnMount, e) === !1)
  );
}
function ui(e, t) {
  return li(e, t) || (e.state.data !== void 0 && di(e, t, t.refetchOnMount));
}
function di(e, t, n) {
  if (wr(t.enabled, e) !== !1 && Cr(t.staleTime, e) !== `static`) {
    let r = typeof n == `function` ? n(e) : n;
    return r === `always` || (r !== !1 && pi(e, t));
  }
  return !1;
}
function fi(e, t, n, r) {
  return (
    (e !== t || wr(r.enabled, e) === !1) &&
    (!n.suspense || e.state.status !== `error`) &&
    pi(e, n)
  );
}
function pi(e, t) {
  return wr(t.enabled, e) !== !1 && e.isStaleByTime(Cr(t.staleTime, e));
}
function mi(e, t) {
  return !Mr(e.getCurrentResult(), t);
}
...
var _i = class extends pr {
  ...
  find(e) {
    let t = { exact: !0, ...e };
    return this.getAll().find((e) => Er(t, e));
  }
  findAll(e = {}) {
  ...
  resumePausedMutations() {
    ...
    return Jr.batch(() => Promise.all(e.map((e) => e.continue().catch(yr))));
  }
};
function vi(e) {
  return e.options.scope?.id;
}
var yi = class extends pr {
    constructor(e = {}) {
    ...
    findAll(e = {}) {
      let t = this.getAll();
      return Object.keys(e).length > 0 ? t.filter((t) => Tr(e, t)) : t;
    }
    notify(e) {
      Jr.batch(() => {
        this.listeners.forEach((t) => {
  ...
  bi = class {
    ...
    mount() {
      (this.#a++,
        this.#a === 1 &&
          ((this.#o = mr.subscribe(async (e) => {
            e && (await this.resumePausedMutations(), this.#e.onFocus());
          })),
          (this.#s = Yr.subscribe(async (e) => {
    ...
    cancelQueries(e, t = {}) {
      let n = { revert: !0, ...t },
        r = Jr.batch(() => this.#e.findAll(e).map((e) => e.cancel(n)));
    ...
    setQueryDefaults(e, t) {
      this.#r.set(Or(e), { queryKey: e, defaultOptions: t });
    }
    getQueryDefaults(e) {
      let t = [...this.#r.values()],
        n = {};
      return (
        t.forEach((t) => {
          kr(e, t.queryKey) && Object.assign(n, t.defaultOptions);
        }),
        n
      );
    }
    setMutationDefaults(e, t) {
      this.#i.set(Or(e), { mutationKey: e, defaultOptions: t });
    }
    getMutationDefaults(e) {
      ...
      return (
        t.forEach((t) => {
          kr(e, t.mutationKey) && Object.assign(n, t.defaultOptions);
        }),
        n
      );
    }
  ...
  Ci = ({ client: e, children: t }) => (
    ...
    (0, x.jsx)(xi.Provider, { value: e, children: t })
  ),
  wi = _.createContext(!1),
  Ti = () => _.useContext(wi);
wi.Provider;
function Ei() {
  let e = !1;
...
var Di = _.createContext(Ei()),
  Oi = () => _.useContext(Di),
  ki = (e, t, n) => {
    let r =
      n?.state.error && typeof e.throwOnError == `function`
        ? Hr(e.throwOnError, [n.state.error, n])
        : e.throwOnError;
  ...
  ji = ({
    ...
    !e.isFetching &&
    r &&
    ((i && e.data === void 0) || Hr(n, [e.error, r])),
  Mi = (e) => {
    if (e.suspense) {
      let t = 1e3,
...
function Ii(e, t, n) {
  ...
  if (
    (_.useSyncExternalStore(
      _.useCallback(
        (e) => {
          let t = f ? u.subscribe(Jr.batchCalls(e)) : yr;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !Wr.isServer() &&
      Ni(d, r) &&
      (l ? Fi(o, u, i) : s?.promise)?.catch(yr).finally(() => {
        u.updateResult();
      }),
...
function zi() {
  let [e, t] = (0, _.useState)(!1),
    [n, r] = Qn(),
    { theme: i, toggleTheme: a } = fr(),
    o = parseInt(n.get(`page`) || `1`),
    s = Si(),
    [c, l] = (0, _.useState)(() => {
      let e = localStorage.getItem(`searchTermTemp`);
      return e ? e.trim() : ``;
    }),
    {
      data: u,
      ...
      queryKey: [`characters`, o, c],
      queryFn: async () => {
        let e = new URLSearchParams();
        (c && e.append(`name`, c), e.append(`page`, String(o)));
        let t = await fetch(
          `https://rickandmortyapi.com/api/character?${e.toString()}`
        );
        if (!t.ok) throw Error(`Failed to string`);
        return t.json();
      },
      select: (e) => ({
        items: e.results.map((e) => ({
          name: e.name,
          description: e.species,
          image: e.image,
          id: e.id,
        })),
        totalPages: e.info.pages,
      }),
    }),
    p = (e) => {
      (l(e), r({ page: `1` }));
  ...
  return (
    (h = d
      ? (0, x.jsx)(`div`, { children: `Loading...` })
      : f
        ? (0, x.jsxs)(`div`, { children: [`Error: `, f.message] })
        : (0, x.jsx)(ae, { items: u?.items })),
    (0, x.jsxs)(Zt, {
      children: [
        (0, x.jsx)(Yt, {
          path: `/`,
          element: (0, x.jsxs)(`div`, {
            className: `bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors max-w-4xl mx-auto p-4 min-h-screen flex flex-col gap-4`,
            children: [
              (0, x.jsxs)(`div`, {
              ...
              (0, x.jsx)(ee, { onSearch: p }),
              (0, x.jsxs)(oe, {
                fallback: (0, x.jsx)(`div`, {
                  className: `flex items-center gap-3 p-4 bg-red-50 border border-red-200 text-red-700 rounded-xl shadow-sm animate-fade-in`,
                  children: (0, x.jsx)(`div`, {
                    className: `flex-1`,
                    children: (0, x.jsx)(`p`, {
                      className: `text-xs text-red-600/90 mt-0.5`,
                      children: `Error button clicked`,
                    }),
                  }),
                }),
                children: [
                  e && (0, x.jsx)(Ri, {}),
                  (0, x.jsx)(`div`, { children: h }),
                ],
              }),
              !d &&
                !f &&
                u?.items.length > 0 &&
                (0, x.jsxs)(`div`, {
                  className: `flex items-center justify-center gap-8 w-full mt-6`,
                  children: [
                    (0, x.jsx)(`button`, {
                      onClick: () => r({ page: String(o - 1) }),
                      disabled: o === 1,
                      className: `w-28 bg-green-500 text-[#0000000] px-4 py-2 rounded-lg hover:bg-green-300 cursor-pointer duration-300`,
                      children: `Previous`,
                    }),
                    (0, x.jsxs)(`span`, {
                      className: `inline-block px-3 py-1.5 text-sm font-medium text-slate-700 bg-slate-50 border border-slate-200 rounded-full shadow-sm tracking-wide`,
                      children: [`Page `, o, ` of `, u?.totalPages ?? 1],
                    }),
                    (0, x.jsx)(`button`, {
                      onClick: () => r({ page: String(o + 1) }),
                      disabled: o === u?.totalPages,
                      className: `w-28 bg-green-500 text-[#0000000] px-4 py-2 rounded-lg hover:bg-green-300 cursor-pointer duration-300`,
                      children: `Next`,
                    }),
                  ],
              ...
              (0, x.jsxs)(`div`, {
                className: `flex justify-start mt-auto gap-3`,
                children: [
                  (0, x.jsx)(`button`, {
                    onClick: m,
                    ...
                    children: `Error click`,
                  }),
                  (0, x.jsx)(`button`, {
                    onClick: () =>
                      s.invalidateQueries({ queryKey: [`characters`] }),
                    className: `w-28 bg-green-500 text-[#0000000] px-4 py-2 rounded-lg hover:bg-green-300 cursor-pointer duration-300`,
                    children: `Refresh`,
                  }),
                ],
        ...
        (0, x.jsx)(Yt, { path: `/about`, element: (0, x.jsx)(lr, {}) }),
        (0, x.jsx)(Yt, { path: `*`, element: (0, x.jsx)(ur, {}) }),
      ],
    })
  );
}
function Bi({ children: e }) {
  let [t, n] = (0, _.useState)(`light`),
    r = () => {
      n((e) => (e === `light` ? `dark` : `light`));
    },
    i = (0, _.useMemo)(() => ({ theme: t, toggleTheme: r }), [t]);
  return (
    (0, _.useEffect)(() => {
      document.documentElement.classList.toggle(`dark`, t === `dark`);
    }, [t]),
    (0, x.jsx)(dr, { value: i, children: e })
  );
}
var M = new bi();
(0, v.createRoot)(document.getElementById(`root`)).render(
  (0, x.jsx)(_.StrictMode, {
    children: (0, x.jsx)(Ci, {
      ...
      children: (0, x.jsx)(Vn, {
        basename: `/React-RSS`,
        children: (0, x.jsx)(Bi, { children: (0, x.jsx)(zi, {}) }),
      }),
    }),
  })
);
